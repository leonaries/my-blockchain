...
import (
	...
	"my-blockchain-new/docs"
	myblockchainnewmodulekeeper "my-blockchain-new/x/myblockchainnew/keeper"
)

const (
	// Name is the name of the application.
	Name = "my-blockchain-new"
...
type App struct {
	*runtime.App
	...
	MyblockchainnewKeeper myblockchainnewmodulekeeper.Keeper
